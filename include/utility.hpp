...
#define DECLARE_ENUM_MAPPING(T1, T2, ...) cxxtc::utility::internal::enum_map<T1, T2>(__VA_ARGS__)
#define DECLARE_ENUM_MAPPING_BOOL(T1, T2, ...) cxxtc::utility::internal::enum_map<T1, T2>(__VA_ARGS__)
...
template<std::floating_point T, cxxtc::traits::StringLike S>
...
namespace cxxtc::utility {

template<cxxtc::traits::StringLike T = std::string>
...
} // @END OF namespace cxxtc::utility

//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

namespace cxxtc::utility::internal {

template<cxxtc::traits::StringLike T>
struct oversized_array
{
    std::array<cxxtc::traits::string_char_type_t<T>, VTM_BIGARRAY_SIZE> data{};
    std::size_t size;
};
...
template<typename Callable, cxxtc::traits::StringLike T>
consteval auto to_right_sized_array(Callable callable)
{
    ...
    std::array<cxxtc::traits::string_char_type_t<std::remove_cvref_t<T>>, oversized.size> result;
...
template<typename Callable, cxxtc::traits::StringLike TString, cxxtc::traits::StringViewLike TView>
...
template<cxxtc::traits::DefaultableEnum In,
         std::semiregular Out,
         cxxtc::traits::SameAsReturn<Out>... Mappings>
...
template<cxxtc::traits::DefaultableEnum In, typename Out, typename... OutArgs>
...
} // @END OF namespace cxxtc::utility::internal
...
template<std::invocable Callable,
         cxxtc::traits::StringLike TString = std::string,
         cxxtc::traits::StringViewLike TView = std::string_view>
consteval auto compile_time_string(Callable callable) -> std::remove_cvref_t<TView>
{
    static_assert(
        std::is_same_v<cxxtc::traits::string_char_type_t<TString>, cxxtc::traits::string_char_type_t<TView>>,
