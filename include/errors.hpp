...
} // @END OF namespace cxxtc::errors

//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

namespace cxxtc::errors::internal
{
...
} // @END OF namespace cxxtc::errors::internal
...
#define __SIGNAL_MSG(s) cxxtc::errors::internal::signal_msg<std::string_view>(s)
...
#define __DIAGMSG_ASSERT(prefix, expr, msg) if (!(expr)) { __DIAGMSG_PREQUIT("APPLICATION", cxxtc::errors::Signal::fail_assert); \
...
#define VTM_PANIC(msg)          __DIAGMSG_PREQUIT("APPLICATION", cxxtc::errors::Signal::fail_panic); __DIAGMSG_PANIC(msg)
#define VTM_TODO(msg)           __DIAGMSG_PREQUIT("APPLICATION", cxxtc::errors::Signal::fail); __DIAGMSG_QUIT("TODO", msg, cxxtc::errors::Signal::fail)
