...
TEST_CASE("type conversions for chrono fps", "[timecode][chrono][framerate][conversion][static]")
{
    ...
    cxxtc::fpsfloat_t fps_float_24   = fps::to_float(fps_24);   cxxtc::fpsint_t fps_int_24   = fps::to_signed(fps_24);   auto fps_str_24   = fps::to_string(fps_24);
    cxxtc::fpsfloat_t fps_float_25   = fps::to_float(fps_25);   cxxtc::fpsint_t fps_int_25   = fps::to_signed(fps_25);   auto fps_str_25   = fps::to_string(fps_25);
    cxxtc::fpsfloat_t fps_float_29   = fps::to_float(fps_29);   cxxtc::fpsint_t fps_int_29   = fps::to_signed(fps_29);   auto fps_str_29   = fps::to_string(fps_29);
    cxxtc::fpsfloat_t fps_float_29df = fps::to_float(fps_29df); cxxtc::fpsint_t fps_int_29df = fps::to_signed(fps_29df); auto fps_str_29df = fps::to_string(fps_29df);
    cxxtc::fpsfloat_t fps_float_30   = fps::to_float(fps_30);   cxxtc::fpsint_t fps_int_30   = fps::to_signed(fps_30);   auto fps_str_30   = fps::to_string(fps_30);
    cxxtc::fpsfloat_t fps_float_60   = fps::to_float(fps_60);   cxxtc::fpsint_t fps_int_60   = fps::to_signed(fps_60);   auto fps_str_60   = fps::to_string(fps_60);
